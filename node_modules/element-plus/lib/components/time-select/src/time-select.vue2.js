  ...
  setup(__props, { expose: __expose }) {
    ...
    const step = vue.computed(() => {
      ...
      if (isInvalidStep) {
        error.debugWarn(
          "ElTimeSelect",
          `invalid step, fallback to default step (${timeSelect.DEFAULT_STEP}).`
        );
      }
      return !isInvalidStep ? utils.formatTime(time) : timeSelect.DEFAULT_STEP;
    });
    const items = vue.computed(() => {
      ...
      if (props.start && props.end && props.step) {
        ...
        if (props.includeEndTime && end.value && ((_a = result[result.length - 1]) == null ? void 0 : _a.rawValue) !== end.value) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.unref(index.ElSelect), {
        ...
        _: 1
        /* STABLE */
      }, 8, ["name", "model-value", "disabled", "clearable", "clear-icon", "size", "effect", "placeholder", "filterable", "empty-values", "value-on-clear", "popper-class", "popper-style"]);
    };
  }
});
