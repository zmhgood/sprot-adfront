...
declare const __VLS_export: import("vue").DefineComponent<__VLS_WithDefaultsLocal<__VLS_TypePropsToOption<RateProps>, {
    ...
    voidColor: string;
    disabledVoidColor: string;
    icons: Array<import("element-plus/es/utils").IconPropType> | Record<number, import("element-plus/es/utils").IconPropType>;
    voidIcon: import("element-plus/es/utils").IconPropType;
    disabledVoidIcon: import("element-plus/es/utils").IconPropType;
    texts: string[];
    scoreTemplate: string;
}, {}>;
