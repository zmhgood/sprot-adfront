...
var ElTableColumn = vue.defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const globalConfig = useGlobalConfig.useGlobalConfig("table");
    ...
    vue.onBeforeMount(() => {
      ...
      const showOverflowTooltip = type === "selection" ? false : types.isUndefined(props.showOverflowTooltip) ? (_b = parent.props.showOverflowTooltip) != null ? _b : (_a = globalConfig.value) == null ? void 0 : _a.showOverflowTooltip : props.showOverflowTooltip;
      const tooltipFormatter = types.isUndefined(props.tooltipFormatter) ? (_d = parent.props.tooltipFormatter) != null ? _d : (_c = globalConfig.value) == null ? void 0 : _c.tooltipFormatter : props.tooltipFormatter;
      const defaults = {
