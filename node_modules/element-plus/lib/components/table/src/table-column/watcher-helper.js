...
function useWatcher(owner, props_) {
  ...
  const registerNormalWatchers = () => {
    ...
    if (globalConfig.value && shared.hasOwn(globalConfig.value, "showOverflowTooltip")) {
      vue.watch(
        () => {
          var _a;
        ...
        (newVal) => {
          if (instance.columnConfig.value.type === "selection") return;
          if (!types.isUndefined(props_.showOverflowTooltip) || !types.isUndefined(owner.value.props.showOverflowTooltip))
            return;
