...
export declare const selectProps: {
    ...
    tagTooltip: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => TagTooltipProps) | (() => TagTooltipProps) | ((new (...args: any[]) => TagTooltipProps) | (() => TagTooltipProps))[], unknown, unknown, () => {}, boolean>;
