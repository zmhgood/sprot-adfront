declare const __VLS_export: import("vue").DefineComponent<{
    ...
    tagTooltip: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => import("./select").TagTooltipProps) | (() => import("./select").TagTooltipProps) | ((new (...args: any[]) => import("./select").TagTooltipProps) | (() => import("./select").TagTooltipProps))[], unknown, unknown, () => {}, boolean>;
