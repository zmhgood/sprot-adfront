declare const __VLS_export: import("vue").DefineComponent<{
    ...
    readonly tagTooltip: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => import("./defaults").TagTooltipProps) | (() => import("./defaults").TagTooltipProps) | ((new (...args: any[]) => import("./defaults").TagTooltipProps) | (() => import("./defaults").TagTooltipProps))[], unknown, unknown, () => {}, boolean>;
    ...
    readonly tagTooltip: import("./defaults").TagTooltipProps;
