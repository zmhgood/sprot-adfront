...
function useWatcher(owner, props_) {
  ...
  const registerNormalWatchers = () => {
    ...
    if (globalConfig.value && hasOwn(globalConfig.value, "showOverflowTooltip")) {
      watch(
        () => {
          var _a;
        ...
        (newVal) => {
          if (instance.columnConfig.value.type === "selection") return;
          if (!isUndefined(props_.showOverflowTooltip) || !isUndefined(owner.value.props.showOverflowTooltip))
            return;
