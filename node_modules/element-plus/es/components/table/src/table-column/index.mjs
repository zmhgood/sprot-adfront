...
var ElTableColumn = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    onBeforeMount(() => {
      ...
      const showOverflowTooltip = type === "selection" ? false : isUndefined(props.showOverflowTooltip) ? (_b = parent.props.showOverflowTooltip) != null ? _b : (_a = globalConfig.value) == null ? void 0 : _a.showOverflowTooltip : props.showOverflowTooltip;
      const tooltipFormatter = isUndefined(props.tooltipFormatter) ? (_d = parent.props.tooltipFormatter) != null ? _d : (_c = globalConfig.value) == null ? void 0 : _c.tooltipFormatter : props.tooltipFormatter;
      const defaults = {
        ...cellStarts[type],
        id: columnId.value,
        type,
