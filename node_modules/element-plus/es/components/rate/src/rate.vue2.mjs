...
import { defineComponent, inject, ref, computed, markRaw, watch, createElementBlock, openBlock, unref, normalizeStyle, normalizeClass, createCommentVNode, Fragment, renderList, createVNode, withCtx, withDirectives, createBlock, resolveDynamicComponent, vShow, toDisplayString } from 'vue';
...
const _hoisted_1 = ["id", "aria-label", "aria-labelledby", "aria-valuenow", "aria-valuetext", "aria-valuemax", "tabindex", "aria-disabled"];
