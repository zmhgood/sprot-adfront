...
import { defineComponent, computed, createElementBlock, openBlock, normalizeClass, unref, renderSlot, createVNode, Transition, withCtx, createCommentVNode, normalizeStyle, createTextVNode, toDisplayString } from 'vue';
      ...
      return openBlock(), createElementBlock(
        ...
        [
          ...
          createVNode(Transition, {
            ...
            default: withCtx(() => [
              !__props.hidden && (content.value || __props.isDot || _ctx.$slots.content) ? (openBlock(), createElementBlock(
                "sup",
                {
                  key: 0,
