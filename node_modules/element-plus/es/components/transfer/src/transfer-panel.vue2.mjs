...
import { defineComponent, useSlots, reactive, computed, toRefs, createElementBlock, openBlock, normalizeClass, unref, createElementVNode, createCommentVNode, createVNode, isRef, withCtx, toDisplayString, createBlock, withDirectives, Fragment, renderList, vShow, renderSlot, createTextVNode } from 'vue';
              ...
              createVNode(unref(ElCheckbox), {
                ...
                default: withCtx(() => [
                  createElementVNode(
                    "span",
                    {
                      class: normalizeClass(unref(ns).be("panel", "header-title"))
                    },
                  ...
                  createElementVNode(
                    "span",
                    {
                      class: normalizeClass(unref(ns).be("panel", "header-count"))
                    },
